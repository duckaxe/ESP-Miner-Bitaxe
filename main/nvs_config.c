...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_STRATUM_CERT]                          = {.nvs_key_name = "stratumcert",     .type = TYPE_STR,   .default_value = {.str = CONFIG_STRATUM_CERT},                         .rest_name = "stratumCert",                        .min = 0,  .max = NVS_STR_LIMIT},
    ...
    [NVS_CONFIG_FALLBACK_STRATUM_CERT]                 = {.nvs_key_name = "fbstratumcert",   .type = TYPE_STR,   .default_value = {.str = CONFIG_FALLBACK_STRATUM_CERT},                .rest_name = "fallbackStratumCert",                .min = 0,  .max = NVS_STR_LIMIT},
